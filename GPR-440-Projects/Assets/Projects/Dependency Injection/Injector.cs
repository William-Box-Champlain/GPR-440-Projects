...
namespace DependencyInjection
{
    ...
    public class Injector : MonoBehaviour
    {
        ...
        private void Awake()
        {
            var monoBehaviors = FindMonoBehaviours();

            var providers = monoBehaviors.OfType<IDependencyProvider>();
            foreach (var provider in providers)
            {
                Register(provider);
            }

            var injectables = monoBehaviors.Where(IsInjectable);
            {
        ...
        public void ValidateDependencies()
        {
            ...
            var invalidDependencies = monoBehaviors
        ...
        {
            foreach (var monoBehavior in FindMonoBehaviours())
            {
